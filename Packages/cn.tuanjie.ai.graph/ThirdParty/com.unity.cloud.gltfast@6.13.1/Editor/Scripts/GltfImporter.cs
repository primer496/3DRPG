...
namespace GLTFast.Editor
{
    ...
    class GltfImporter : ScriptedImporter
    {
        ...
        {
            // to trigger reimport when asset post processors which have a OnPostprocessModel event handler change
            ctx.DependsOnCustomDependency(ScriptedImporterAssetPostProcessing.OnPostprocessModel.CustomDependency);
            ...
            // call the OnPostprocessModel event
            ScriptedImporterAssetPostProcessing.OnPostprocessModel.Invoke(ctx)?.Invoke((GameObject)ctx.mainObject);
        }

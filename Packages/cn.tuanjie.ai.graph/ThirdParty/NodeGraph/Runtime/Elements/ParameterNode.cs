...
namespace GraphProcessor
{
	...
	public class ParameterNode : BaseNode
	{
		...
		protected override void Enable()
		{
			...
			graph.onExposedParameterDisplayChanged += OnParamChanged;
		...
		{
			if (parameter.settings.accessor == ParameterAccessor.Get)
			{
		...
		{
			if (parameter.settings.accessor == ParameterAccessor.Set)
			{
				yield return new PortData
				{
					identifier = "input",

...
namespace GraphProcessor
{
	...
	{
		public string			title;
		public Color			color = new Color(0.9f, 0.5f, 0.5f, 0.2f);
		public Rect				position;
        public Vector2          size;
		public bool expanded = true; // node group collapsed state
		...
		/// <summary>
		/// Store the related position before collapse
		/// </summary>
		public Dictionary<string, Rect> innerNodeOrgPos = new();

...
namespace GraphProcessor
{
    ...
    public class BaseStackNodeView : StackNode
    {
        ...
        public virtual void Initialize(BaseGraphView graphView)
        {
            ...
            {
                stackNode.expanded = !stackNode.expanded;
        ...
        {
            RemoveFromClassList(stackNode.expanded ? "collapsed" : "expanded");
            AddToClassList(stackNode.expanded ? "expanded" : "collapsed");
            DisplayStyle dispStyle = stackNode.expanded ? DisplayStyle.Flex : DisplayStyle.None;
            VisualElement container = this.Q("stackNodeContainers");
            if (container != null)
            {
                container.style.display = dispStyle;
            }
        }

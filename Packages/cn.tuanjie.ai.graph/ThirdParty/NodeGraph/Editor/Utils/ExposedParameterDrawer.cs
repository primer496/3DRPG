...
namespace GraphProcessor
{
    ...
    public class ExposedParameterDrawer : PropertyDrawer
    {
        ...
        protected SerializedProperty GetNameProperty(SerializedProperty property) => property.FindPropertyRelative("_name");
    ...
    public class ExposedParameterSettingsDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            settings.Bind(property.serializedObject);

            settings.Add(CreateHideInInspectorField(property));
            settings.Add(CreateAccesorField(property));
            return settings;
        }
        ...
        protected VisualElement CreateHideInInspectorField(SerializedProperty settingsProperty)
        {
            ...
            p.RegisterValueChangeCallback(e => {
                ...
                graph.NotifyExposedParameterDisplayChanged(param);
            });

            return p;
        }

        protected VisualElement CreateAccesorField(SerializedProperty settingsProperty)
        {
            var accesor = settingsProperty.FindPropertyRelative(nameof(ExposedParameter.Settings.accessor));
            var graph = GetGraph(settingsProperty);
            var param = GetParameter(settingsProperty);
            var p = new PropertyField(accesor, "Accessor");
    ...
    public class ExposedColorSettingsDrawer : ExposedParameterSettingsDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty settingsProperty)
        {
            ...
            settings.Add(CreateAccesorField(settingsProperty));

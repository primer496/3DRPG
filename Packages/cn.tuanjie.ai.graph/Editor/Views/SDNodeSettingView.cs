...
namespace UnityEditor.AIGraph
{
	public class SDNodeSettingView : VisualElement
	{
        ...
        public SDNodeSettingView(TJAINodeSetting settings, TJAIGraphView owner, string title = "Node Output Settings", bool showSettingsForNode = true)
        {
            this.graph = owner.graph as TJAIGraph;
		...
		void AddRealtimeFields(TJAIGraphView owner)
		{
		...
		void UpdateFieldVisibility(TJAINodeSetting settings)
		{

...
namespace UnityEngine.AIGraph
{
    ...
    public class StandaloneFileBrowserWindows : IStandaloneFileBrowser {
        ...
        public void OpenFilePanelAsync(string title, string directory, ExtensionFilter[] extensions, bool multiselect, Action<string[]> cb) {
            _OpenFilePanelAsync(title, directory, extensions, multiselect, cb);
        }

        public async static void _OpenFilePanelAsync(string title, string directory, ExtensionFilter[] extensions, bool multiselect, Action<string[]> cb)
        {
            var openFilePanelTask = Task.Run(() =>
            {
                return StandaloneFileBrowser.OpenFilePanel(title, directory, extensions, multiselect);
            });
            string[] filenames = await openFilePanelTask;
            cb.Invoke(filenames);
        }
